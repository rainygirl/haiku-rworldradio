...
Result Get(const std::string& url)
{
	...
	// SDK) only have the single-argument form, where a second bool argument
	// is a hard error. HAIKU_BURL_HAS_BOOL_CTOR is set by the Makefile
	// per-SDK - see its comment.
